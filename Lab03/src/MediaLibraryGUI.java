 ...
 * 
 * If you want to add additional queries to your program, take a
 * look at the setUpGUI method.  You can add an additional query
 * by creating a new Box similar to the 4 boxes that are created
 * in this GUI.  Build the GUI elements, add them to the Box,
 * then add the box to the queryPanel.  You'll also need to 
 * provide code within the actionPerformed method to respond
 * to events.
 */
public class MediaLibraryGUI extends JPanel {
	...
	private void setUpGUI() {
		...
		this.fileNameTF.setText("X:\\CSCE270\\workspace\\Lab03\\src\\media.txt");
	...
	private class QueryListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if( source == fullListButton ) {
				...
				// Delete this and replace with appropriate code to implement
				// the full list by price button.
				//outputArea.setText("");
				//outputArea.append("Button not implemented yet.\n");
				
			} else if( source == fullListByTitleButton ) {
				// Delete this and replace with appropriate code to implement
				// the full list by title button.
				outputArea.setText("");
				outputArea.append("Button not implemented yet.\n");
			}
		}
